...
def generate_dataset(duration_s: int) -> dict:
    ...
    print()
    print(f"  Alarm events generated: {len(dataset['alarm_events'])}")
...
def write_to_neo4j(normalised_alarms: list, simba_incidents: list,
    ...
    with driver.session() as session:
        ...
        print("  Cleared previous Incident and NormalisedAlarm nodes.")
...
def main():
    ...
    # Step 3
    normalised_alarms = normalise_alarms(dataset["alarm_events"])
