...
def build_fiber_cut_scenario(base_dt: datetime) -> FaultScenario:
    ...
    Timeline:
      ...
      t=92s    Backhaul transport failure on gNB-MUM-SITE-B01 (Ericsson ENM)
    ...
    alarms = [
        ...
        AlarmEvent(
            ...
            alarm_details     = "Backhaul N2 transport link failure on gNB-MUM-SITE-B01. Upstream fiber cut on Mumbai-Chennai span.",
            service_affecting=True, is_root_cause=False,
